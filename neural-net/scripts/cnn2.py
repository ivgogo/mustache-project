...
def main(mode, batch_size, learning_rate, num_epochs):
    ...
    labels_train = "/home/ivang/hayat_data/ready/train/y/y.csv"
    labels_val = "/home/ivang/hayat_data/ready/val/y/y.csv"

    # freqs paths are variable
    freqs_train = os.path.join("/home/ivang/hayat_data/ready/train/",f"{mode}/{mode}.csv")
    freqs_val = os.path.join("/home/ivang/hayat_data/ready/val/",f"{mode}/{mode}.csv")
